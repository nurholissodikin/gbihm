                  ...
                  <div class="col-md-12">
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <input type="text" name="gereja" class="form-control" placeholder="Gereja Asal">
                      </div>
                    </div>
                    <div class="col-md-12">
                      <div class="form-group">
                        <label>Mulai Berjamaat</label>
                        <div class="input-group date">
                          <div class="input-group-addon">
                            <i class="fa fa-calendar"></i>
                          </div>
                          <input type="text" name="berjemaat" class="form-control datepickerlight" autocomplete="off" placeholder="Mulai Berjemaat">
                        </div>
                      </div>
                    </div>
                    <div class="col-md-12">
                    ...
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <div class="input-group date">
                          ...
                          <input type="text" name="tala" class="form-control datepickerlight" autocomplete="off" placeholder="Tanggal">
                        </div>
                      </div>
                    </div>
