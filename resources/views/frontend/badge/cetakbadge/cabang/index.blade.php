                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <a href="{{ url('mdpj/cetak_badge/detail',$data->id)}}" type="submit" class="btn btn-block-small btn-info btn-xs"><i class="fa fa-eye"></i></a>
                          <button onclick="location.href='{{ url('mdpj/cetak_badge/order',$data->id)}}'" @if($status =='Waiting Acc') disabled @elseif($statusa == 'Sedang Dalam Proses') disabled @elseif($statusa == 'Sudah Terbit') disabled @endif class="btn btn-block-small bg-navy btn-xs ">Order</button>
                          <button onclick="location.href='{{ url('mdpj/cetak_badge/cetak',$data->id)}}'" @if($status =='Waiting Acc') disabled @elseif($statusa == '') disabled @elseif($statusa == 'Sedang Dalam Proses') disabled @endif class="btn btn-block-small bg-navy btn-xs ">Badge</button>
