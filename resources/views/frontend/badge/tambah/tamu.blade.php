              ...
              <form  id="formtamu" enctype="multipart/form-data" method="post">
                ...
                <div class="col-md-3 pull-right">
                  <div class="avatar-upload">
                    <div class="avatar-edit">
                      <input type='file' id="imageUpload5" accept=".jpg" name="urlphoto" />
                ...
                <div class="col-md-9">
                  <div class="form-group">
                    ...
                    <input type="text" name="nama" class="form-control" placeholder="Nama (Sesuai KTP)" required="" @if ($user->role->name == 'Pelayan') value="{{$user->name}}" @else value ="" @endif>
                  </div>
                </div>
                <div class="col-md-9">
                  <div class="form-group">
                ...
                <div class="col-md-9">
                  <div class="form-group">
                    ...
                    <label class="col-sm-3">
                      <input type="radio" name="jk" class="minimal" value="P" required="">Perempuan
                    </label>
                  </div>
                </div>
                <div class="col-md-12">
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    <label>Jenis</label>
                    <select class="form-control select2" name="jenis_b" style="width: 100%;">
