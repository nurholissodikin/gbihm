                   ...
                   <?php $no++ ;?>
                    <tr>
                     ...
                     <td><a href="{{ url('mdpj/pengerja/detail',$data->id)}}" type="submit" class="btn btn-block-small btn-info btn-xs">{{$data->idpersonal}}</a></td>
                      ...
                      <td>
                        <button onclick="location.href='{{ url('pengerja_approve/gembalarayon',$data->id)}}'" @if($approve =='Di Acc') disabled @endif class="btn btn-block-small btn-success btn-xs ">Acc</button>
