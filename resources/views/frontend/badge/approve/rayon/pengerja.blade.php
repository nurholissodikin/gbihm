                     ...
                     <?php $no++ ;?>
                      <tr>
                        <?php 
                            ...
                            if($data->approve_gembala_rayon != null){
                                $kirim="disable";
                              }
                              else {
                                $kirim = "";
                              ...
                              if($data->approve_gembala_rayon=='0'){
                                $approvea="Waiting Acc Gembala Rayon";
                                $coloraa="bg-maroon";
                              }else if($data->approve_gembala_rayon=='1'){
                          ...
                          ?>
                        <td><input type="checkbox" name="kirima[]" class="selected-all" value="{{$data->id}}" @if($approve =='Waiting Acc'){ disabled  } @elseif($kirim =='disable') disabled  checked @endif></td>
                        <td>{{$no}}</td>
