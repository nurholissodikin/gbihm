          ...
          <div class="box">
                ...
                <div class="col-md-12">
                  <div class="col-md-12">
                   <div class="form-group">
                    ...
                    <input type="text" name="kodediv" class="form-control" placeholder="Kode Divisi" required="">
                   </div>
                  </div>
                  <div class="col-md-12">
                   <div class="form-group">
                     <label>Nama Divisi</label>
                     <input type="text" name="namadiv" class="form-control" placeholder="Nama Divisi">
                   </div>
                  </div>
                  <div class="col-md-12">
                   <div class="form-group">
            ...
            <div class="box-body"> 
              <div class="box box-info">
                <div class="box-header">
                   <h3 class="box-title">List Divisi</h3>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
                    ...
                    <table id="example2" class="table table-bordered table-hover" style="width: 100%">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>{{$data->status}}</td>
                           <form action="{{route('divisi.destroy',$data->iddivisi)}}" method="post">
                              <input name="_method" type="hidden" value="DELETE">
                              <input name="_token" type="hidden">     
                               <td>
                                 <a href="{{ route('divisi.show',$data->iddivisi)}}" type="submit" class="btn btn-xs btn-block-small btn-primary"><i class="fa fa-credit-card"></i></a>
                                 <a href="{{ url('/divisi/detail/'.$data->iddivisi)}}" type="submit" class="btn btn-xs btn-block-small btn-info"><i class="fa fa-eye"></i></a>
                                 <a href="{{ route('divisi.edit',$data->iddivisi)}}" type="submit" class="btn btn-xs btn-block-small btn-warning"><span class="glyphicon glyphicon-edit"></span></a>
                                 <button type="submit"  class="btn btn-block-small btn-danger btn-xs " onclick=" return confirm('Apakah anda yakin akan menghapus data ?');" ><i class="fa fa-remove"></i></button>
                                 {{csrf_field()}}
                              </td>            
                           </form>      
                        </tr>
