              ...
              <div class="tab-content"> 
                <div role="tabpanel" class="tab-pane fade in active" id="cabang"> 
                  ...
                  <div class="box">
                    <div class="box-header">
                      <div class="col-md-6">
                       <h3 class="box-title">List Data Personal Cabang-</h3>
                      </div>
                      ...
                      <table id="example1" class="table table-bordered table-striped">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>
                              <a href="{{ url('cabang/personal/detail/'.$data->personal->idpersonal)}}" type="submit" class="btn btn-xs btn-block-small btn-info"><i class="fa fa-eye"></i></a>
                              <a href="{{ url('cabang/personal/edit/'.$data->personal->idpersonal)}}" type="submit" class="btn btn-xs btn-block-small btn-warning"><span class="glyphicon glyphicon-edit"></a>
                            </td>                             
                          </tr>
                          @endforeach 
                        </tbody>
