      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <div class="box-body">
              <form  action="{{url('cabang/personal/upd/'.$personal->idpersonal)}}" enctype="multipart/form-data" method="post">
                <input type="hidden" name="_method" value="PUT">
                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                @foreach($anggota as $data)
                <input type="hidden" name="idcabangranting" value="{{$data->idcabangranting}}">
                @endforeach
