      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <div class="box-body">
              <form  action="{{route('kebaktian.store')}}" enctype="multipart/form-data" method="post">
                {{csrf_field()}}
                    ...
                    <div class="col-md-12">
                      ...
                      <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <input type="text" name="ruang" class="form-control" placeholder="Tempat / Ruang">
                        </div>
                      </div>
                       <div class="col-md-12">
                        <div class="form-group">
                          <label>Kordinator</label>
                          <input type="text" name="kordinator" class="form-control" placeholder="Kode Pos">
                        </div>
                      </div>
                      <div class="col-md-12">
                        <div class="form-group">
