  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">List Data Personal Subrayon</li>
      </ol>
    </section>
    <br>
              ...
              <div class="tab-content"> 
                <div role="tabpanel" class="tab-pane fade in active" id="cabang"> 
                  ...
                  <div class="box">
                    <div class="box-header">
                      <div class="col-md-6">
                       <h3 class="box-title">List Data Personal Subrayon - </h3>
                      </div>
                      ...
                      <table id="example1" class="table table-bordered table-striped">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>
                              <a href="{{ url('subrayon/personal/detail/'.$data->personal->idpersonal)}}" type="submit" class="btn btn-xs btn-block-small btn-info"><i class="fa fa-eye"></i></a>
                              <a href="{{ url('subrayon/personal/edit/'.$data->personal->idpersonal)}}" type="submit" class="btn btn-xs btn-block-small btn-warning"><span class="glyphicon glyphicon-edit"></a>
                            </td>                             
                          </tr>
                          @endforeach 
                        </tbody>
