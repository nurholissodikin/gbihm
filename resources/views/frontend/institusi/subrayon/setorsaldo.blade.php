        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Sub Rayon</h3>
            </div>
            <div class="box-body">
                ...
                <div class="tab-content">
                  <div role="tabpanel" class="tab-pane fade in active" id="rayon"> 
                    ...
                    <br>
                    <form  action="{{url('saldosub')}}" enctype="multipart/form-data" method="post">
                    {{csrf_field()}}
                      <div class="col-md-12"> 
                      <input type="hidden" name="idsubrayon" value="{{$subrayon->idsubrayon}}">
                        <div class="col-md-12">
                        ...
                        <div class="col-md-12">
                         <div class="form-group">
                          ...
                          <input type="file" name="doksub" class="form-control">
                         </div>
                        </div>
