                  ...
                  <div role="tabpanel" class="tab-pane fade in active" id="subrayon"> 
                    ...
                    <div class="box">
                      <div class="box-header">
                        ...
                        <a href="{{ url('/subrayon/setorsaldo',$subrayon->idsubrayon)}}" class="btn btn-primary pull-right" ><i class="fa fa-plus"> Setor Saldo</i></a>
                      </div>
                      <!-- /.box-header -->
                      <div class="box-body">
                        <table id="example1" class="table table-bordered table-striped">
                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td>{{$data->active}}</td>
                              <td>{{$data->subrayon->pemimpin}}</td>    
                              <td>
                                <a href="{{url('/subrayon/saldo/detail/'.$data->idtransaksi)}}" type="submit" class="btn btn-block-small btn-warning">Detail</a>
                              </td>                 
                            </tr>
                            @endforeach 
                          </tbody>
