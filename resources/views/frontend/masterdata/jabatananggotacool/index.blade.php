      ...
      <div class="row">
        <div class="col-md-12">
            ...
            <!-- /.box-header -->
             <div class="box-body">
              <div class="box-header with-border">
               <h3 class="box-title">Tambah Data Jabatan Anggota COOL</h3>
              </div>
              <br>
              <form  action="{{route('jabatananggotacool.store')}}" enctype="multipart/form-data" method="post">
              {{csrf_field()}}
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">List Data Jabatan Anggota COOL</h3>
            </div>
            <div class="box-body">
                ...
                <table width="100%" class="table table-bordered table-hover" id="example3" cellspacing="0">
                  ...
                  <tbody>
                    ...
                    <tr class="item{{$item->id}}">
                      ...
                      <td>
                        <a href="{{ route('jabatananggotacool.edit',$item->id)}}" type="submit" class="btn btn-block-small btn-warning btn-xs"><span class="glyphicon glyphicon-edit"></span></a>
...
<script type="text/javascript">
  function del_jabatancool(id){
    swal({
      title: "Apakah Anda Ingin Menghapus Jabatan Anggota COOL ?",
      icon: "warning",
      buttons: true,
      dangerMode: true,
    })
    .then((oke) => {
      if (oke) {
        $.get("{{url('jabatananggotacool/delete')}}"+"/"+id,function(){
          swal({
