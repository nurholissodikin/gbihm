            ...
            <!-- /.box-header -->
             <div class="box-body">
              <div class="box-header with-border">
               <h3 class="box-title">Edit Peserta BP2N</h3>
              </div>
              <br>
              <form  action="{{route('bp2npeserta.update',$peserta->id)}}" enctype="multipart/form-data" method="post">
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <td>
                      ...
                      <?php If (in_array("Pra Nikah", $peserta->kategori))
                            { echo "checked"; } 
                      ?> > Pra Nikah
                    </td>
                    <td>
                      <input type="checkbox" name="kategori[]" class="minimal" value="Pasca Nikah" 
                      <?php If (in_array("Pasca Nikah", $peserta->kategori))
                            { echo "checked"; } 
                      ?>> Pasca Nikah
                    </td>
                  </div>                   
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group date">
                      <select class="form-control select2" name="pria" id="id_pria" style="width: 100%;" >
                        ...
                        <option value="{{$data->idpersonal}}" <?php echo ($peserta->idpria == $data->idpersonal ) ? "selected" : "" ?>>{{$data->idpersonal}} | {{$data->namalengkap}}</option>
                        @endforeach
                      </select>
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group date">
                      <select class="form-control select2" name="wanita" id="id_wanita" style="width: 100%;" >
                        ...
                        <option value="{{$data->idpersonal}}" <?php echo ($peserta->idwanita == $data->idpersonal ) ? "selected" : "" ?>>{{$data->idpersonal}} | {{$data->namalengkap}}</option>
                        @endforeach
                      </select>
                      <div class="input-group-addon">
                        <a href="{{url('/create')}}" target="_blank" class="btn btn-primary pull-right btn-xs" ><i class="fa fa-plus"> Personal</i></a>
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input type="number" name="angkatan" value="{{$peserta->angkatan}}" class="form-control">
                  </div>                  
                </div>
