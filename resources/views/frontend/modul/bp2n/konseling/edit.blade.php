          ...
          <div class="box box-default">
            <!-- /.box-header -->
             <div class="box-body">
              ...
              <br>
              <form  action="{{route('bp2nkonseling.update',$konseling->id)}}" enctype="multipart/form-data" method="post">
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <div class="input-group date">
                      ...
                      <input type="text" name="tanggal" value="{{$konseling->tanggal}}" placeholder="Tanggal Berlaku" class="form-control datepickerlight">
                    </div>
                  </div>                   
                </div>
                 <div class="col-md-12">
                  <div class="form-group">
                    <label>Tempat</label>
                    <input type="text" name="tempat" class="form-control" value="{{$konseling->tempat}}" placeholder="Tempat">
                  </div>                  
                </div>
                <div class="col-md-12">
                  <div class="form-group">
                    <label>Pejabat</label>
                    <input type="text" name="pejabat" class="form-control" value="{{$konseling->pejabat}}" placeholder="Pejabat">
                  </div>                  
                </div>
                <div class="col-md-12">
                  <div class="form-group">
                    <label>Peserta</label>
                      <select class="form-control select2" name="peserta" id="id_peserta" style="width: 100%;" >
                        ...
                        <option value="{{$data->id}}" <?php echo ($konseling->idpeserta == $data->id) ? "selected" : "" ?>>{{$data->idpria}} | {{$data->pria['namalengkap']}}</option>
                        @endforeach
                      </select>
                  </div>                  
                </div>
