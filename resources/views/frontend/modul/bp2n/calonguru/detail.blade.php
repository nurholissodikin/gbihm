          ...
          <div class="box box-default">
            ...
            <div class="box-body">
              <div class="box-header with-border">
               <h3 class="box-title">Detail Data Calon Guru</h3>
              ...
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <div class="col-md-6">
                    <label>: {{$calonguru->idpersonal}}</label>
                  </div>
              ...
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <div class="col-md-6">
                    <label>: {{$calonguru->personal['namalengkap']}}</label>
                  </div>
                </div>
                <div class="col-md-4 pull-right">
               ...
               <div class="col-md-12">
                <div class="form-group">
                  ...
                  <div class="col-md-6">
                    @php
                    $a=$calonguru->personal['jeniskelamin'];
                    if($a == 'L')
                    {
                     $b="Laki-Laki";
                    }else if($a == 'P')
              ...
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <div class="col-md-6">
                    <label>: {{$calonguru->angkatan}}</label>
                  </div>
                </div>
                <div class="col-md-4 pull-right">
              ...
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <div class="col-md-6">
                    <label>: {{$calonguru->jenis_jabatan}}</label>
                  </div>
                </div>
                <div class="col-md-4 pull-right">
              ...
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <div class="col-md-6">
                    <label>: {{$calonguru->keterangan}}</label>
                  </div>
                </div>
                <div class="col-md-4 pull-right">
