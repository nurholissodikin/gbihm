        ...
        <div class="col-md-12">
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">List Tugas Akhir</h3>
            </div>
            <div class="box-body">
                ...
                <table width="100%" class="table table-bordered table-hover data-table"cellspacing="0">
                  ...
                  <tbody id="kom_data">
                    ...
                    <tr class="item{{$item->id}}">
                      ...
                      <td>{{$item->tugas}}</td>
                      <td>
                        <a href="{{ route('tugas.edit',$item->id)}}" type="submit" class="btn btn-block-small btn-warning btn-xs"><span class="glyphicon glyphicon-edit"></span></a>
                      </td>
                    </tr>
                    @php $no++ @endphp
                    @endforeach
