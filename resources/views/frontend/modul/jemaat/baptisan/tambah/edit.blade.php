        ...
        <div class="col-xs-12">
          <div class="box box-info">
            <div class="box-header">
              <h3 class="box-title">Edit Data Akta Batisan</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <section>
                <div class="wizard">
                  ...
                  <form role="form" action="{{url('baptisan/akta_update',$baptisan->idbaptisan)}}" enctype="multipart/form-data" method="post" >
