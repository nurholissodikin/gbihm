    ...
    <section class="content">
      <div class="row">
        <div class="col-xs-12">
          ...
          <a href="{{url('modul/pelayanjemaat/baptisan/pendaftaran')}}" class="btn btn-primary active">Form Pendaftaran Baptisan</a>
          <a href="{{url('modul/pelayanjemaat/baptisan/tambahakta')}}" class="btn btn-primary">Tambah Akta Baptisan</a>
          <div class="box box-info">
            <div class="box-header">
              <h3 class="box-title">Pendaftaran Batisan Air</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <section>
                <div class="wizard">
                  ...
                  <form role="form" action="{{url('baptisan/caper_store')}}" enctype="multipart/form-data" method="post" id="formba">
                     {{csrf_field()}}
                  <input type="hidden" name="method_type">  
                    <div class="tab-content">
                      <div class="tab-pane active" role="tabpanel" id="step1">
                        @include('frontend.modul.jemaat.baptisan.pendaftaran.personal')
                      </div>
                      <div class="tab-pane" role="tabpanel" id="step2"> 
                        @include('frontend.modul.jemaat.baptisan.pendaftaran.dokumen')
                      </div>
                      <div class="tab-pane" role="tabpanel" id="step3">
                        @include('frontend.modul.jemaat.baptisan.pendaftaran.berita')
                      </div>
                      <div class="tab-pane" role="tabpanel" id="complete">
                        @include('frontend.modul.jemaat.baptisan.pendaftaran.keterangan')
                      </div>
                    </div>
                  </form>
                </div>
