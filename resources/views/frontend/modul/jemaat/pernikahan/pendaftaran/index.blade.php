    ...
    <section class="content">
      <div class="row">
        <div class="col-xs-12">
          ...
          <a href="{{url('modul/pelayanjemaat/pernikahan/pendaftaran')}}" class="btn btn-primary active">Form Pendaftaran Pernikahan</a>
          <a href="{{url('modul/pelayanjemaat/pernikahan/tambahakta')}}" class="btn btn-primary">Tambah Akta Pernikahan</a>
          <div class="box box-info">
            <div class="box-header">
              <h3 class="box-title">Pendaftaran Pernikahan</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <section>
                <div class="wizard">
                  ...
                  <form role="form" action="{{url('pernikahan/caper_store')}}" enctype="multipart/form-data" method="post" id="formba">
                     {{csrf_field()}}
