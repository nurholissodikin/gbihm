    ...
    <section class="content">
      <div class="row">
        <div class="col-xs-12">
          ...
          <a href="{{url('modul/pelayanjemaat/pernikahan/tambahakta')}}" class="btn btn-primary active">Tambah Akta Pernikahan</a>
          <div class="box box-info">
            <div class="box-header">
              <h3 class="box-title">Tambah Akta Pernikahan</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <section>
                <div class="wizard">
                  ...
                  <form role="form" action="{{url('pernikahan/akta_store')}}" enctype="multipart/form-data" method="post" id="formba">
                     {{csrf_field()}}
                  <input type="hidden" name="method_type">  
                   <input type="hidden"  name="status" value="Menerima Akta Pernikahan" class="form-control" >
                    <div class="tab-content">
                      <div class="tab-pane active" role="tabpanel" id="step1">
                        @include('frontend.modul.jemaat.pernikahan.pendaftaran.personal')
                      </div>
                      <div class="tab-pane" role="tabpanel" id="step2"> 
                        @include('frontend.modul.jemaat.pernikahan.pendaftaran.dokumen')
                      </div>
                      <div class="tab-pane" role="tabpanel" id="step3">
                        @include('frontend.modul.jemaat.pernikahan.pendaftaran.berita')
                      </div>
                      <div class="tab-pane" role="tabpanel" id="complete">
                        @include('frontend.modul.jemaat.pernikahan.pendaftaran.keterangan')
                      </div>
                    </div>
                  </form>
                </div>
