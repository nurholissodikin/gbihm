        ...
        <div class="col-xs-12">
          <div class="box box-info">
            <div class="box-header">
              <h3 class="box-title">Edit Tambah Akta Pernikahan</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <section>
                <div class="wizard">
                  ...
                  <form role="form" action="{{url('pernikahan/akta_update',$pernikahan->idpernikahan)}}" enctype="multipart/form-data" method="post" id="formba">
                    <input type="hidden" name="_token" value="{{csrf_token()}}">
                    <input type="hidden" name="_method" value="PUT">
                    <input type="hidden" name="method_type">  
                    <input type="hidden" name="status" value="Menerima Akta Pernikahan">
