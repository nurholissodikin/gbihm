    ...
    <section class="content">
      <div class="row">
        <div class="col-xs-12">
          ...
          <a href="{{url('modul/pelayanjemaat/penyerahananak/pendaftaran')}}" class="btn btn-primary active">Form Pendaftaran Penyerahan Anak</a>
          <a href="{{url('modul/pelayanjemaat/penyerahananak/tambahakta')}}" class="btn btn-primary">Tambah Akta Penyerahan Anak</a>
          <div class="box box-info">
            <div class="box-header">
              <h3 class="box-title">Pendaftaran Penyerahan Anak</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <section>
                <div class="wizard">
                  ...
                  <form role="form" action="{{url('anak/caper_store')}}" enctype="multipart/form-data" method="post" id="formba">
                     {{csrf_field()}}
