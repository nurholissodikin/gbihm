    ...
    <section class="content">
      <div class="row">
        <div class="col-xs-12">
          ...
          <a href="{{url('modul/pelayanjemaat/penyerahananak/tambahakta')}}" class="btn btn-primary active">Tambah Akta Penyerahan Anak</a>
          <div class="box box-info">
            <div class="box-header">
              <h3 class="box-title">Tambah Akta Penyerahan Anak</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <section>
                <div class="wizard">
                  <div class="wizard-inner">
                    ...
                    <ul class="nav nav-tabs" role="tablist">
                      <li role="presentation" class="active">
                        <a href="#step1" data-toggle="tab" aria-controls="step1" role="tab" title="Data Penyerahan Anak">
                      ...
                      <li role="presentation" class="disabled">
                        <a href="#step2" data-toggle="tab" aria-controls="step2" role="tab" title="Dokumen Penyerahan Anak">
                          <span class="round-tab">
                  ...
                  <form role="form" action="{{url('anak/akta_store')}}" enctype="multipart/form-data" method="post" id="formba">
                     {{csrf_field()}}
                  <input type="hidden" name="method_type">  
                  <input type="hidden" name="status" value="Menerima Akta Penyerahan Anak">  
                    <div class="tab-content">
                      <div class="tab-pane active" role="tabpanel" id="step1">
                        @include('frontend.modul.jemaat.anak.pendaftaran.personal')
                      </div>
                      <div class="tab-pane" role="tabpanel" id="step2"> 
                        @include('frontend.modul.jemaat.anak.pendaftaran.dokumen')
                      </div>
                      <div class="tab-pane" role="tabpanel" id="step3">
                        @include('frontend.modul.jemaat.anak.pendaftaran.berita')
                      </div>
                      <div class="tab-pane" role="tabpanel" id="complete">
                        @include('frontend.modul.jemaat.anak.pendaftaran.keterangan')
                      </div>
                    </div>
                  </form>
                </div>
...
@push('scriptz')
  <script type="text/javascript">
    $(document).ready(function () {
     ...
     $('#id_anakibupersonal').on('change', function(){
        if($('#id_anakibupersonal').val()){
     ...
     $('#id_anakayahpersonal').on('change', function(){
        if($('#id_anakayahpersonal').val()){
