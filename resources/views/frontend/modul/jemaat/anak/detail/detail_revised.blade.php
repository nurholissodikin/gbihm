        ...
        <div class="col-xs-12">
          <div class="box box-info">
            <div class="box-header">
              <h3 class="box-title">Detail Revised Pendaftaran Penyerahan Anak</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <section>
                <div class="wizard">
                  ...
                  <form role="form" action="{{url('anak/caper_update',$anak->idpenyanak)}}" enctype="multipart/form-data" method="post" id="formba">
