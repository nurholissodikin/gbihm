...
@section('content')
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="row">
        <div class="col-xs-12">
          <a href="{{url('modul/pelayanjemaat/peneguhan/caper')}}" class="btn btn-primary">Calon Peserta Calon Peserta Peneguhan</a>
          <a href="{{url('dokumenanak')}}" class="btn btn-primary">Master Dokumen</a>
          <a href="{{url('modul/pelayanjemaat/peneguhan/pendaftaran')}}" class="btn btn-primary">Form Pendaftaran Calon Peserta Peneguhan</a>
          <a href="{{url('modul/pelayanjemaat/peneguhan/tambahakta')}}" class="btn btn-primary active">Tambah Akta Calon Peserta Peneguhan</a>
          <div class="box box-info">
            <div class="box-header">
              <h3 class="box-title">Tambah Akta Peneguhan Nikah</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <section>
                <div class="wizard">
                  ...
                  <form role="form" action="{{url('peneguhan/akta_store')}}" enctype="multipart/form-data" method="post" id="formba">
                    {{csrf_field()}}
                    <input type="hidden"  name="status" value="Menerima Akta Peneguhan" class="form-control" >
                    <input type="hidden" name="method_type">  
                    <div class="tab-content">
                      <div class="tab-pane active" role="tabpanel" id="step1">
                        @include('frontend.modul.jemaat.peneguhan.pendaftaran.personal')
                      </div>
                      <div class="tab-pane" role="tabpanel" id="step2"> 
                        @include('frontend.modul.jemaat.peneguhan.pendaftaran.dokumen')
                      </div>
                      <div class="tab-pane" role="tabpanel" id="step3">
                        @include('frontend.modul.jemaat.peneguhan.pendaftaran.berita')
                      </div>
                      <div class="tab-pane" role="tabpanel" id="complete">
                        @include('frontend.modul.jemaat.peneguhan.pendaftaran.keterangan')
                      </div>
                    </div>
                  </form>
                </div>
