    ...
    <section class="content">
      <div class="row">
        ...
        <div class="col-md-6">
          <div class="box box-info">
            <div class="box-header bg-info">
              <h3 class="box-title ">Detail Data Peserta Peneguhan Nikah Data Suami - Akta Peneguhan Nikah</h3>
        ...
        <div class="col-md-6">
          <div class="box box-info">
            <div class="box-header bg-info">
              <h3 class="box-title ">Detail Data Peserta Peneguhan Nikah Data Istri - Akta Peneguhan Nikah</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">             
              <div class="row">
