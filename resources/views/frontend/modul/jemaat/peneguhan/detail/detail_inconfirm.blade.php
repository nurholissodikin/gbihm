    ...
    <section class="content">
      <div class="row">
        ...
        <div class="col-md-6">
          <div class="box box-info">
            <div class="box-header bg-info">
              <h3 class="box-title ">Data Peserta Peneguhan Nikah Data Suami - Inconfirm</h3>
        ...
        <div class="col-md-6">
          <div class="box box-info">
            <div class="box-header bg-info">
              <h3 class="box-title ">Data Peserta Peneguhan Nikah Data Istri - Inconfirm</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">             
              <div class="row">
                ...
                <div class="col-md-12">
                  ...
                  <div class="col-md-6">
                    <div class="demo-button">
                      <button type="button" class="btn btn-primary btn-group-responsivey prev-step form-control">Approve</button>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="demo-button">
                      <button type="submit" class="btn btn-primary btn-group-responsive form-control">Revised</button>
                    </div>
                  </div>
                </div>
              </div>
