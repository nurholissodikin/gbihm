   ...
   <form method="POST" action="{{ url('change/pw') }}" >
      ...
      {{csrf_field()}}
       ...
       <div class="input-icon  {{ $errors->has('email') ? ' has-error' : '' }} has-feedback">
        <input id="input" type="text" name="email" value="{{ $personal->idpersonal }}" placeholder="Ketikan ID Anda" required autofocus>
      ...
      <div class="input-icon {{ $errors->has('password') ? ' has-error' : '' }} has-feedback">
        <input id="input" class="ini" type="password" name="password" required placeholder="Masukan Password Baru">
      ...
      <div class="input-icon {{ $errors->has('password') ? ' has-error' : '' }} has-feedback">
        <input id="input" class="ini" type="password" name="password_confirmation" required placeholder="Ketik Ulang Password">
        <i class="fac fa-lock"></i>
        <span toggle=".ini" class="fa fa-fw fa-eye field-icon toggle-password"></span>
        <span class="glyphicon glyphicon-lock form-control-feedback"></span>
        @if ($errors->has('password'))
